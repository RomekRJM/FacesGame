...
public class AchievementManager {
    public static final Achievement[] achievements = new Achievement[]{
            ...
            new Achievement(12, "Prayen", "Complete 5 games", "face_11.png", "0", new TotalGamesAchievementUpdater(10)),
            new Achievement(13, "Cooka", "Complete 25 games", "face_12.png", "0", new TotalGamesAchievementUpdater(25)),
            new Achievement(14, "Weeper", "Complete 75 games", "face_13.png", "0", new TotalGamesAchievementUpdater(75)),
            new Achievement(15, "Zigzag", "Reach score 250", "face_14.png", "0", new ScoreAchievementUpdater(250)),
            new Achievement(16, "Afraido", "Reach score 500", "face_15.png", "0", new ScoreAchievementUpdater(500)),
            ...
            new Achievement(29, "Coolejandro", "Reach normal difficulty.", "face_24.png", "EASY", new DifficultyAchievementUpdaterImpl(Difficulty.NORMAL)),
            new Achievement(30, "Wack", "Reach hard difficulty.", "face_25.png", "EASY", new DifficultyAchievementUpdaterImpl(Difficulty.HARD)),
            new Achievement(31, "Piranhers", "Reach hardcore difficulty.", "face_26.png", "EASY", new DifficultyAchievementUpdaterImpl(Difficulty.HARDCORE)),
            new Achievement(32, "Volodia", "Guess 3 different people from Russia.", "face_28.png", "0", new GuessPeopleFromCountryUpdater(3, "Russia")),
            new Achievement(33, "Hangovery", "Guess 3 different people from Netherlands.", "face_29.png", "0", new GuessPeopleFromCountryUpdater(3, "Netherlands")),
            new Achievement(34, "Fabulo", "Guess 3 different people from USA.", "face_42.png", "0", new GuessPeopleFromCountryUpdater(3, "United States")),
            new Achievement(35, "Huzar", "Guess 3 different people from Poland.", "face_43.png", "0", new GuessPeopleFromCountryUpdater(3, "Poland")),
            new Achievement(36, "Gimper", "Play two days in a row.", "face_41.png", "0", new ConsecutiveDaysPlayingAchievementUpdater(2)),
            new Achievement(37, "Septiceye", "Play three days in a row.", "face_68.png", "0", new ConsecutiveDaysPlayingAchievementUpdater(3)),
            new Achievement(38, "Pewds", "Play four days in a row.", "face_69.png", "0", new ConsecutiveDaysPlayingAchievementUpdater(4)),
            new Achievement(39, "Danil", "Play five days in a row.", "face_39.png", "0", new ConsecutiveDaysPlayingAchievementUpdater(5)),
            new Achievement(40, "Laggy", "Guess people from 10 different countries.", "face_27.png", "0", new CountriesCorrectlyGuessedAchievementUpdater(10)),
            new Achievement(41, "Occlusio", "Guess people from 25 different countries.", "face_30.png", "0", new CountriesCorrectlyGuessedAchievementUpdater(25)),
            new Achievement(42, "Nowatchy", "Guess people from 50 different countries.", "face_31.png", "0", new CountriesCorrectlyGuessedAchievementUpdater(50)),
            new Achievement(43, "Omnibi", "Guess people from 100 different countries.", "face_32.png", "0", new CountriesCorrectlyGuessedAchievementUpdater(100)),
            new Achievement(44, "Laughy", "Guess 5 people, that you haven't previously.", "face_33.png", "0", new RightGuessesThatWerePreviouslyWrongAchievementUpdater(5)),
            new Achievement(45, "Pinkulla", "Guess 10 people, that you haven't previously.", "face_34.png", "0", new RightGuessesThatWerePreviouslyWrongAchievementUpdater(10)),
            new Achievement(46, "Vomito", "Guess 20 people, that you haven't previously.", "face_35.png", "0", new RightGuessesThatWerePreviouslyWrongAchievementUpdater(20)),
            new Achievement(47, "Angrezzi", "Guess 40 people, that you haven't previously.", "face_36.png", "0", new RightGuessesThatWerePreviouslyWrongAchievementUpdater(40)),
    };
