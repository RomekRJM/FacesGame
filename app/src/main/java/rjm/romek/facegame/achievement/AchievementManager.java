...
public class AchievementManager {
    public static final Achievement[] achievements = new Achievement[]{
            new Achievement(1, "Grucho", "Guess 5 in a row.", "face_1.png", "0", new GuessingSpreeAchievement(5)),
            new Achievement(2, "Teether", "Guess 7 in a row.", "face_2.png", "0", new GuessingSpreeAchievement(7)),
            ...
            new Achievement(15, "Zigzag", "Reach score 500.", "face_14.png", "0", new ScoreAchievementUpdater(500)),
            new Achievement(16, "Afraido", "Reach score 1000.", "face_15.png", "0", new ScoreAchievementUpdater(1000)),
            new Achievement(17, "Yuppz", "Reach score 1500.", "face_16.png", "0", new ScoreAchievementUpdater(1500)),
            new Achievement(18, "Unlucko", "Reach score 2000.", "face_17.png", "0", new ScoreAchievementUpdater(2000)),
            new Achievement(19, "Watchy", "Reach score 3000.", "face_18.png", "0", new ScoreAchievementUpdater(3000)),
            ...
            new Achievement(24, "Onetimo", "Gather 2500 points in any number of games.", "face_19.png", "0", new TotalScoreAchievementUpdater(2500)),
            new Achievement(25, "Ohmydo", "Gather 5000 points in any number of games.", "face_20.png", "0", new TotalScoreAchievementUpdater(5000)),
            new Achievement(26, "Karminia", "Gather 10000 points in any number of games.", "face_21.png", "0", new TotalScoreAchievementUpdater(10000)),
